package comf55119035.example.listofquotes;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("List of Qutes/F55119035");
        }
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "token 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");
